...
3. **Problema** — frequência, intensidade e evidências (Company Context).
...
27. **Riscos** — riscos e mitigação (`company/risks.md`).
...
32. **Decisões pendentes** — questões ainda abertas (`.companify/decisions.md`).
