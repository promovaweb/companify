...
- **Fontes de verdade:** ler todos os artefatos de `company/`,
  `.companify/assumptions.md`, `.companify/decisions.md`,
...
1. Ler a [rubrica de auditoria](references/audit-rubric.md) e aplicar cada
   dimensão: consistência, evidência, hipóteses apresentadas como fato,
...
3. Verificar se toda projeção em `company/finance.md` cita premissa ou
   cenário.
4. Verificar se toda decisão relevante tem entrada em
   `.companify/decisions.md` com rastreabilidade.
5. Verificar se os riscos críticos de `company/risks.md` têm mitigação.
6. Verificar se `company/business-plan.md` contradiz alguma decisão
...
Auditar por cadeia de evidência: Company Context, artefato especializado,
...
achado bloqueia o uso do plano.
